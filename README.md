...
| -------------------------------------------------------------- | ------------------------------------------------------------------------------- | ----------------- | ------------------ |
| [Prusa XL](https://www.prusa3d.com/product/original-prusa-xl/) | [6.2.0](https://github.com/prusa3d/Prusa-Firmware-Buddy/releases/tag/v6.2.0)    | 2.1.2             | :white_check_mark: |
